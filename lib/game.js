    ...
    _buildTicTacMessage(){
        ...
        for(var i = 0; i < this._board.length; i++) {
            ...
            for(var j = 0; j < this._board[i].length; j++) {
                ...
                ticTacInterfaces.blocks[i].elements[j].value = this._mapCoordstoMove(i,j);
                ticTacInterfaces.blocks[i].elements[j].action_id = this._mapCoordstoMove(i,j);
                //console.log(this._mapCoordstoMove(i,j));
            }
        }
